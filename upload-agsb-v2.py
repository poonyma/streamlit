...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "s1agv2"         # 用户名
UUID = "f51fc463-217f-411f-aae0-4aff24c4ef33"                     # UUID，留空则自动生成
PORT = 52520                   # Vmess端口，留空或0则自动生成
DOMAIN = "streamlit.leziren.eu.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiZmQ3NmNiODBiZTBhOWMzMzY0MjE1Mzg1NTUwM2RkZDEiLCJ0IjoiZjZlZjEwZGUtOGI5My00ZDgyLTg5MGMtNmIxOTE0NTEwMThkIiwicyI6IllqUmxOek16WldFdE9UVmpPUzAwWXpFNUxXRXlPVE10WmpBNU1HRmpZak5pTWprMCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
